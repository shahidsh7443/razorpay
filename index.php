...
<html lang="en">
<head>
<title>Razorbee Electronic Store a Ecommerce Online Shopping Category Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
...
var str=$('.sbmincart-subtotal').text();
var amount=str.substring(str.lastIndexOf("s.")+2,str.lastIndexOf(".0"));
var total=parseInt(amount)*100;
    /*document.cookie = "myJavascriptVar="+total;*/
});
	</script>
	...
	<div class="header" id="home1">
		<div class="container">
			...
			<div class="w3l_logo">
				<a href="index.php"><img src="rlogo.png" alt="Razorbee" class="logoimg" title="Razorbee Electronic Store"></a>
				<!--<h1><a href="index.php">Razorbee Electronic Store<span>Your stores. Your place.</span></a></h1>-->
			</div>
			<!--<div class="search">
			...
			<div class="cart cart box_1">
				<form id="sub" method="post" class="last">
					<input type="hidden" name="cmd" value="_cart" />
					<input type="hidden" name="display" value="1" />
					<button class="w3view-cart" type="submit" name="submit"  name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
				</form>
			</div>
		</div>
	</div>
	...
	$.ajax({
	                ...
	                data: form_data,
	                success: function(  ){
	                $(".w3ls-cart").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -60px;margin-left: -180px;'>Thankyou for Contacting us</span>");
	               },
	                error: function( aa ){
	                  $("w3ls-cart").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -60px;margin-left: -180px;'>Thankyou for Contacting us</span>");
...
<div class="payment">
  <form action="test.php" class="paylist" method="POST" onsubmit="alert('hi')">
	...
	<!--<button id="rzp-button1" class="hidden-lg hidden-md">Checkout</button>-->

      <script src="https://checkout.razorpay.com/v1/checkout.js"></script>
			<script>
var options = {
    "key": "rzp_test_TRKMUBm8H1UW8j",
...
document.getElementById('rzp-button1').onclick = function(e){
	...
	<div class="banner">
		<div class="container">
			<h3>Razorbee Store, <span>Special Offers</span></h3>
		</div>
	</div>
	<!-- //banner -->
	<!-- banner-bottom -->
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.380</span> <i class="item_price">Rs.350</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
											<input type="hidden" name="w3ls_item" value="Mobile Phone1" />
											<input type="hidden" name="amount" value="350.00" />
											<button type="submit" name="submit"  class="w3ls-cart">Add to cart</button>
										</form>
									</div>
								</div>
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.330</span> <i class="item_price">Rs.302</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.250</span> <i class="item_price">Rs.245</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
						...
						<div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.320</span> <i class="item_price">Rs.250</i></p></div>
									<div class="simpleCart_shelfItem">
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.180</span> <i class="item_price">Rs.150</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.220</span> <i class="item_price">Rs.180</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
						...
						<div role="tabpanel" class="tab-pane fade" id="video" aria-labelledby="video-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.880</span> <i class="item_price">Rs.850</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.290</span> <i class="item_price">Rs.280</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.120</span> <i class="item_price">Rs.80</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
						...
						<div role="tabpanel" class="tab-pane fade" id="tv" aria-labelledby="tv-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.950</span> <i class="item_price">Rs.820</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.700</span> <i class="item_price">Rs.680</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.520</span> <i class="item_price">Rs.510</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
						...
						<div role="tabpanel" class="tab-pane fade" id="kitchen" aria-labelledby="kitchen-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.460</span> <i class="item_price">Rs.450</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.390</span> <i class="item_price">Rs.350</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>Rs.250</span> <i class="item_price">Rs.220</i></p>
										<form id="sub" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" />
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								<p><span>Rs.960</span> <i class="item_price">Rs.920</i></p>
								<form id="sub" method="post">
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="add" value="1">
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								<p><span>Rs.280</span> <i class="item_price">Rs.250</i></p>
								<form id="sub" method="post">
									<input type="hidden" name="cmd" value="_cart">
									<input type="hidden" name="add" value="1">
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>Rs.520</span> <i class="item_price">Rs.500</i></p>
							<form id="sub" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>Rs.380</span> <i class="item_price">Rs.370</i></p>
							<form id="sub" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>Rs.150</span> <i class="item_price">Rs.100</i></p>
							<form id="sub" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1">
	...
	<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>&copy; 2017 Razorbee Electronic Store. All rights reserved | Design by <a href="www.razorbee.com">Razorbee Online Solutions</a></p>
			</div>
		</div>
	</div>
	<!-- //footer -->
